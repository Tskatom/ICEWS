...
python multi_task.py --task keywordsCount --core 40 --inFolder /raid/tskatom/raw_arabia_inform --outFolder /raid/tskatom/arabia_handbook_keywords_count --keywordsFile ../data/keywords/handbook_protest_keywords.txt --start $t_start --end $t_end
