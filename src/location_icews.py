...
class Icews(object):
        ...
        for f in files:
            with open(f) as icews_f:
                ...
                for line in icews_f:
                    ...
                    city = country + "_" + city
                    self.daily_loc_count.setdefault(eventCode, {})
                    self.daily_loc_count[eventCode].setdefault(city, {})
                    loc_count = self.daily_loc_count[eventCode][city].setdefault(eventDate, 0)
                    self.daily_loc_count[eventCode][city][eventDate] = loc_count + 1
    ...
    def write_out(self):
        ...
        for eventCode, eventSet in self.daily_loc_count.items():
...
def parse():
    ...
    ap.add_argument("--outFolder", type=str, default="../data/icews_loc_gsr")
